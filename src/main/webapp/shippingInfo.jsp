	...
	<div class="p-5 mb-4 bg-body-tertiary rounded-3">
		<div class="container-fluid py-5">
			<h1 class="display-5 fw-bold">배송 정보</h1>
				<p class="col-md-8 fs-4">Shipping</p>
		</div>
	</div>
	
	<div class="row align-items-md-stretch">
		<from action="./processShippingInfo.jsp" method="post">
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-3">
					<input type="text" name="zipCode" class="from-control">
				</div>
			</div>
			<div class="mb-3 row">
				<label class="col-sm-2">주소</label>
				<div class="col-sm-5">
					<input type="text" name="addressName" class="from-control">
				</div>
			</div>
			<div class="mb-3 row">
